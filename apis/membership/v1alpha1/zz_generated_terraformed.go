...
func (tr *Membership) GetObservation() (map[string]interface{}, error) {
...
func (tr *Membership) SetObservation(obs map[string]interface{}) error {
...
func (tr *Membership) GetParameters() (map[string]interface{}, error) {
...
func (tr *Membership) SetParameters(params map[string]interface{}) error {
